...
\section{Preface}
These notes are intended to be supplementary material to go along with the lectures for CS 38 as taught at Caltech in Spring of 2016. They in no means replace the content in the lectures and recitation sections of the course, and I highly encourage you attend them. I encourage you to read these lecture notes prior to class as a method of quickly reviewing the material for the course. \\
...
\begin{proof}
Reflexivity is trivial by definition. If $x \in \mathrm{DIVS}(a,b)$ then $\exists \ y, z$ integers such that $xy = a, xz = b$. Therefore, $x(y + z) = a + b$, proving $x \in \mathrm{DIVS}(a+b,b)$. Conversely, if $x' \in \mathrm{DIVS}(a+b,b)$ then $\exists \ y', z'$ integers such that $x' y' = a + b, x' z' = b$. Therefore, $x' (y ' - z') = a$ proving $x' \in \mathrm{DIVS}(a,b)$. Therefore, $\mathrm{DIVS}(a,b) = \mathrm{DIVS}(a+b,b)$. \qed
\end{proof}
...
\begin{proof}
Apply induction. The gcd argument follows at is the max element of the same set. \qed
\end{proof}
